...
#inpout parameters
fps =  300
expected_run_duration = 60     # In seconds
max_idle_time = 10             # In seconds
...
t2 = threading.Thread(target = record_concurrent_applications, args= (closing_event, expected_run_duration,time_steps_for_app_log, file_name))
t1.start()
t2.start()
